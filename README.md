...
For details on how to install the package, load the pretrained encoder, and extract representations from silhouette sequences, see the [Inference Guide (README_infer.md)](README_infer.md).
